...
// api.get("/consulta/:dFechaInicio/:dFechaFin/:nCompra/:nEmpresa/:nProveedor/:nAlmacen/:nArticulo/:cTipoCompra?/:cFactura?", validateToken, Controller.obtenerConsultaCompras);
api.post("/consulta/", validateToken, Controller.obtenerConsultaCompras);
